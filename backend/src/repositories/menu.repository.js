...
function add(itemData) {
  ...
  const newItem = {
    ...
    // Alias per compatibilità semantica con altri moduli
    ...
    // Food cost avanzato – tutti opzionali, non usati dai moduli legacy
...
function update(id, updates) {
  ...
  // Aggiorna eventuali campi food cost (tutti opzionali)
